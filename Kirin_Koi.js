const UA=require('./JS_USER_AGENTS')
...
let utils = {
    ...
    requestUrl: {
        gettoken: "".concat("https://", "rjsb-token-m.jd.com/gettoken"),
    ...
    gettoken: function () {
        ...
        var body = `content={"appname":"50082","whwswswws":"aB5GjTk8gq1FD7MoypZ7WZw","jdkey":"1201e4461b24640164a706c0a3444fd79de6577f","body":{"platform":"1"}}`;
    ...
    get_risk_result: async function ($) {
        ...
        if (!$.joyytoken || $.joyytoken_count >=8) {
		...
		//console.log('当前的joyytoken为:'+$.joyytoken)
        ...
        switch ($.action) {
			case 'startTask':
				return {log:outstr.join("~"),sceneid:"JLHBhPageh5",random,taskType:"0"}
				break;
			case 'h5receiveRedpacketAll':
				return{log: outstr.join("~"),sceneid: "JLHBhPageh5",random,taskType:0}
				break;
			case 'jinli_h5assist':
				return{log: outstr.join("~"),sceneid:"JLHBhPageh5",random,followShop:0,redPacketId:$.redPacketId}
				break;
			default:
				break;
    }
